...
- **Core Schema Entities:** `neighborhoods`, `user_profiles`, `neighborhood_settings`, `announcements`, `forum_posts`, `classified_ads`, `classified_ads_payments`, `content_reports`, `grievances`, `events`.
